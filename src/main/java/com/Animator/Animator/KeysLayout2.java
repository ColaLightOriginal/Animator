...
public class KeysLayout2 extends KeysLayout {
    @Override
    ...
    public boolean faster(int keyCode, char key) {
        return keyCode == 100 || keyCode == 226 || key == '\\';
    }
    ...
    public boolean nextFrame(int keyCode) {
        return keyCode == 104 || keyCode == 224;
    }
    
    @Override
    public boolean lastFrame(int keyCode) {
        return keyCode == 65368 || keyCode == 101;
    }
    
    @Override
    public boolean quickPeak(int keyCode) {
        return keyCode == 127 || keyCode == 108;
    }
